...
const projects = [
  {
    ...
    contribution: "Contributor as a Full Stack Developer",
    image: BUQuarta,
  ...
  return (
    <div className="bg-gray-900 text-white py-20" id="project">
      <div className="container mx-auto px-8 md:px-16 lg:px-24">
        <h2 className="text-5xl font-bold text-center mb-12">Projects and Contributions</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {projects.map((project) => (
            ...
            >
              ...
              <p className="text-gray-400 mb-4">{project.contribution}</p>
